...
export const CategoriesRespnseSchema = z.array(CategorySchema)
...
export const ShoppingCardSchema = z.array(ShoppingCardContentsSchema)


export const CouponResponseSchema = z.object({
   name: z.string().default(''),
   message: z.string(),
   percentage: z.coerce.number().min(0).max(10).default(0)
})
...
export const ProductFormSchema = z.object({
   ...
   image: z.string({ message: 'La imagen es obligatorio' }),
...
export type ShoppingCard = z.infer<typeof ShoppingCardSchema>
export type CardItem = z.infer<typeof ShoppingCardContentsSchema>
